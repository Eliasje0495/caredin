  ...
  return (
    <Document title={`Overeenkomst van Opdracht — ${d.shiftTitle}`} author="CaredIn">
      <Page size="A4" style={s.page}>
        ...
        <NLI n="6">Partijen een groot belang hechten aan de zelfstandigheid en de onafhankelijkheid van Opdrachtnemer;</NLI>
        <NLI n="7">Opdrachtgever zich er uitdrukkelijk mee akkoord verklaart dat Opdrachtnemer ook ten behoeve van andere opdrachtgevers werkzaamheden verricht.</NLI>
      ...
      <Page size="A4" style={s.page}>
        ...
        <H1>2. UITVOERING</H1>
        <H2>2.1. Vrijheid</H2>
        <P>Binnen de door Opdrachtgever gestelde grenzen is Opdrachtnemer vrij zijn werkzaamheden naar eigen professioneel inzicht in te richten en uit te voeren, met inachtneming van de geldende zorgstandaarden en protocollen van de instelling.</P>
      ...
      <Page size="A4" style={s.page}>
        ...
        <H2>3.2. Vervangen</H2>
        <P>Het staat Opdrachtnemer vrij zich bij de werkzaamheden te laten vervangen door een ander, mits deze gekwalificeerd is voor de betreffende zorgtaak. Opdrachtnemer meldt voorafgaand aan de vervanging via het CaredIn-platform wie de werkzaamheden namens hem uitvoert. In alle gevallen waarin Opdrachtnemer zich laat vervangen blijft Opdrachtnemer verantwoordelijk voor de facturering van de met de uitvoering van de Opdracht gemoeide vorderingen.</P>
        ...
        <H2>4.2. Overige kosten</H2>
        <P>In de Vergoeding zijn reiskosten en reistijd begrepen, tenzij uitdrukkelijk anders is overeengekomen. Materiaalkosten worden door Opdrachtgever beschikbaar gesteld.</P>
